...
EXPORT_SYMBOL(led_initialise_status);
/****************************************************************************
 * DEBUG MACROS
 ***************************************************************************/
...
#ifndef CONFIG_OF   //[1191997] support leds device init by device tree modify by liming.zhu at 20151223
