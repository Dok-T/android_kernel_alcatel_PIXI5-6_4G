...
#include "hi553mipiraw_Sensor_rear.h"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI553_SENSOR_ID_REAR,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static void HI553OTPSetting(void)
{
...
static void HI553OTPSettingDeinit(void)
{
  HI553_OTP_write_cmos_sensor(0x0A00, 0x00);//stand by on
  mdelay(10);
...
static kal_uint8 HI553_Sensor_OTP_read(kal_uint16 otp_addr)
{
    kal_uint16 i;
    kal_uint8 data;
    i = otp_addr;
...
static void HI553_Sensor_update_wb_gain(kal_uint32 r_gain, kal_uint32 g_gain,kal_uint32 b_gain)
{
...
static void HI553_Sensor_calc_wbdata(void)
{
	   uint16_t wbcheck = 0,
		 checksum = 0,
		 wb_flag = 0;
...
{
    return read_cmos_sensor(0x0f16) + 0x02;
}
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
				...
				printk("HI553 i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);	
                return ERROR_NONE;
            }
			  printk("HI553 Read sensor id fail, i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);	
            retry--;
        } while(retry > 0);
        i++;
        retry = 1;
...
UINT32 HI553_REAR_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
