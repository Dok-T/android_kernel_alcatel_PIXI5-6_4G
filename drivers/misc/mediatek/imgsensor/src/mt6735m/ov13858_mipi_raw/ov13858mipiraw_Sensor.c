...
int m_bpc_select=0;
//sensor otp
extern void ov13858_otp_cali(unsigned char writeid);
extern unsigned int ov13858_read_mid(unsigned char slave_addr);
...
static int apply_otp(void)
{
	...
	(ov13858_otp_ptr).module_integrator_id , (ov13858_otp_ptr).production_year,(ov13858_otp_ptr).production_month ,(ov13858_otp_ptr).production_day ,
...
static kal_uint32 return_sensor_id(void)
{
    ...
    if (id == OV13858_SENSOR_ID){
	    ...
	    mid = ov13858_read_mid(imgsensor.i2c_write_id);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == OV13858S_SENSOR_ID) {
                LOG_INF("ov13858s was detected!\n");
...
static kal_uint32 open(void)
{
   ...
   // LOG_2;
    ...
    sensor_init();
#ifdef OV13858_OTP
    ov13858_otp_cali(imgsensor.i2c_write_id);
    write_cmos_sensor(0x0100, 0x00);
#endif 
