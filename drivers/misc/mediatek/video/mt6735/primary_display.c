...
#ifdef CONFIG_CUSTOM_KERNEL_LCM_PWRON
extern void lcm_pre_init(void);
#endif
...
#ifdef CONFIG_PROJECT_PIXI5104G
	cust_lcd_init_power_sequence(1);
#else
	/*add by sansan for modifying lcd recovery power on sequence2016-8-30 16:20:14 begin*/
	#ifdef CONFIG_CUSTOM_KERNEL_LCM_PWRON
		lcm_pre_init();
...
int primary_display_resume(void)
{
...
#endif
	/*modify by sansan.gan for task 4008731 on 2017.01.11 begin*/
#ifdef CONFIG_PROJECT_PIXI5104G
	cust_lcd_init_power_sequence(1);
	...
	/*add by sansan for modifying lcd recovery power on sequence2016-8-30 16:20:14 end*/
#endif
       /*modify by sansan.gan for task 4008731 on 2017.01.11 end*/
