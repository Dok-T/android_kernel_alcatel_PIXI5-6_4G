...
static int dw9814_WriteReg(u8 Data1 ,u8 Data2)                                                                                                                           
{
    int  i4RetValue = 0;
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	//LOG_INF("cuckoo move [curr] %ld [target] %ld\n", g_u4CurrPosition, g_u4TargetPosition); 
...
static void DW9814AF_reduce_lens_power_down_noise(void)
{
#if 0
...
static void DW9814AF_Init(void)
{
	LOG_INF("cuckoo %s\n",__func__);
    dw9814_WriteReg(0xEC ,0xA3);
    dw9814_WriteReg(0xA1 ,0x05);                                                                                                                                         
    dw9814_WriteReg(0xF2 ,0x78);
    dw9814_WriteReg(0xDC ,0x51);
}

static void DW9814AF_DeInit(void)
{
	LOG_INF("cuckoo %s\n",__func__);
	DW9814AF_reduce_lens_power_down_noise();
}
/* Main jobs: */
