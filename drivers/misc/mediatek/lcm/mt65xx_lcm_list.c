...
#if defined(R61318_TDT_DSI_VDO)
        &r61318_tdt_dsi_vdo_lcm_drv,
#endif
/* [PLATFORM]-Add-END by TCTSZ.lizhi.wu, 2016.08.23*/

/* [PLATFORM]-Add-BEGIN by TCTSZ.sansan.gan, 2016.10.11, add lcd r61318*/
#if defined(R61318_TDT_DSI_VDO_2ND)
        &r61318_tdt_dsi_vdo_lcm_drv_2nd,
#endif
/* [PLATFORM]-Add-END by TCTSZ.sansan.gan, 2016.10.11*/


/* [PLATFORM]-Add-BEGIN by TCTSZ.sansan.gan, 2016.10.11, add lcd hx8394d*/
#if defined(HX8394F_TXD_DSI_VDO_3RD)
        &hx8394f_txd_dsi_vdo_lcm_drv_3rd,
#endif
/* [PLATFORM]-Add-END by TCTSZ.sansan.gan, 2016.10.11*/


/* [PLATFORM]-Add-BEGIN by TCTSZ.sansan.gan, 2016.10.11, add lcd hx8394d*/
#if defined(HX8394D_TDT_DSI_VDO_4TH)
        &hx8394d_tdt_dsi_vdo_lcm_drv_4th,
#endif
/* [PLATFORM]-Add-END by TCTSZ.sansan.gan, 2016.10.11*/
...
#if defined(RM68200_WXGA_TXD_VDO)
    &rm68200_wxga_dsi_vdo_lcm_drv,
#endif
/*[FEATURE]-add-begin by scdtablet jinghuang@tcl.com,12.16.2016,3762335*/
/*add tdt lcd for global project*/
#if defined(RM68200_WXGA_TDT_VDO)
    &rm68200_tdt_wxga_dsi_vdo_lcm_drv,
#endif
/*[FEATURE]-end*/
#endif
