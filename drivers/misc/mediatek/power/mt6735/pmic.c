...
/*sd oc call back*/
// in this file, add API for pmic.c 
void msdc_sd_oc_power_off(void)
{	
...
void PMIC_EINT_SETTING(void)
{
	...
	pmic_register_interrupt_callback(25,ldo_int_handler);	// (16+9) LDO OC Interrupt
	...
	pmic_enable_interrupt(25,1,"PMIC");	// LDO OC Interrupt
	// pmic_set_register_value(PMIC_RG_INT_EN_LDO_OC, 1);
