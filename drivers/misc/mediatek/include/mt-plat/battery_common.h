...
/* for mmitest  whithout battry power on by bao.li bigen  */
#define BATT_ID_CHECK_SUPPORT 1

#if BATT_ID_CHECK_SUPPORT
#define CHG_MIN_VALID_BATT_ID_JN  100
#define CHG_MAX_VALID_BATT_ID_JN  715
#define CHG_MIN_VALID_BATT_ID_BYD  715
#define CHG_MAX_VALID_BATT_ID_BYD  1055
#define CHG_MIN_VALID_BATT_ID_SCUD  1055
#define CHG_MAX_VALID_BATT_ID_SCUD  1300
#define CHG_MIN_VALID_BATT_ID_VK  1300
#define CHG_MAX_VALID_BATT_ID_VK  1800
#endif
/*[998284] for mmitest  whithout battry power on by bao.li end  */
...
typedef struct {
	...
	unsigned int ZCV;
	unsigned int  id_vol; //[FR571989][add battery id]
} PMU_ChargerStruct;
