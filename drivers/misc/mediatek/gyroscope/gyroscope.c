...
//	int ret = -1;
	...
	/*[BUGFIX]-Mod-BEGIN by zhongzhu.peng.sz,3303757*/
	/*don't load Gyroscope driver unless on MEA or LATAM board*/
//	ret =select_hw_configuration_func();
//	if(ret == 0 || ret == 1 || ret == 5 || ret == 6)
//	{
//		printk("[%s]:hw configuration not MEA or LATAM,exit\n",__func__);
//		return -EINVAL;
//	}
	/*[BUGFIX]-Mod-END by zhongzhu.peng.sz*/
